module.exports = function getAutoSuggestUsers(loginSubstring, limit) 
{
    let users = [...limit];
    ...
    if (filteredUsers.length === 0) return {message: `No such user with "${loginSubstring}" in it as a substring`};
